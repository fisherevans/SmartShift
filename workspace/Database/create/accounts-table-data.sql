...
INSERT INTO `Accounts`.`Business` (`id`, `name`, `addressID`, `buildID`, `servID`) VALUES (1, 'Path E-Tech Computers', 1, 1, 1);
INSERT INTO `Accounts`.`Business` (`id`, `name`, `buildID`, `servID`) VALUES (2, 'Babcock & Sons', 1, 1);
...
INSERT INTO `Accounts`.`UserBusinessEmployee` (`userID`, `busID`, `empID`) VALUES (2, 1, 1);
INSERT INTO `Accounts`.`UserBusinessEmployee` (`userID`, `busID`, `empID`) VALUES (2, 2, 7);
